...
export default function NewAgentForm({ teams, roles, designations }: NewAgentFormProps) {
  ...
  const isSuperAdmin = hasPermission(permissions, 'super-admin');
  ...
  const [profileData, setProfileData] = useState({
    ...
    profileEmergencyContactAddress: '',
    profileEmergencyContactNumber: '',
    profileEmergencyContactNumber2: '',
  });
  ...
  const handleNextTab = () => {
    if (activeTab === 'basic') {
      if (!userData.name || !userData.username || !userData.password || !userData.teamId || !userData.roleId) {
        setError('Please fill in all required fields (Name, Username, Password, Team, and Role).');
        return;
      }
      setError(null);
    ...
    <div ref={containerRef} className="agents-page-container">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Create a new CRM employee account with complete profile details</p>
        </div>
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleUserChange}
                    className="form-input"
                    placeholder="e.g. jdoe@jdfusion.in"
                  />
                </div>
                <div className="form-group">
